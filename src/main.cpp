...
uint256 hashGenesisBlock("0x0000075f19a2a22765e1c2294488e2f6f04ebd1981b8ffb1ab47b4c5d947eec4");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // BeerMoney: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "BeerMoney Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    if(nHeight == 1)
    {
        nSubsidy = 2000000 * COIN;  // 1M coins
...
static const int64 nTargetTimespan = 5 * 60;	// BeerMoney: 5 mins 
static const int64 nTargetSpacing = 60;			// BeerMoney: 60 sec
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal beermoney miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BeerMoney", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0000075f19a2a22765e1c2294488e2f6f04ebd1981b8ffb1ab47b4c5d947eec4");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "In August 5, 2016, Beer Money Was Born. Yehey!. 1470443981.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1470443981;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1752804;
        ...
        assert(block.hashMerkleRoot == uint256("0x2adaa254601e10e7ac7966d386de73ae379661bcb87e6851110d82c1e3e8092b"));
